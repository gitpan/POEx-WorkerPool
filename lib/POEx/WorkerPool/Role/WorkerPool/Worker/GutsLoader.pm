...
=head2 init is: ro, isa: CodeRef, lazy_build: 1
...
=head2 preamble is: ro, isa: CodeRef, lazy_build: 1
...
=head2 main is: ro, isa: CodeRef, lazy_build: 1

This holds the coderef that builds the actual Guts



=head2 prologue is: ro, isa: CodeRef, lazy_build: 1

This holds the coderef that calls run() on POE::Kernel to kickstart everything



=head2 loader is: ro, isa: CodeRef, lazy_build: 1
